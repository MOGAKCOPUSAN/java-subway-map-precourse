...
public class InitService {
    ...
    private void lineBundangInit() {
        List<Station> lineBundangStations = new ArrayList<>(Arrays.asList(StationRepository.findByName("강남역"),
    ...
    private void line3Init() {
        List<Station> line3Stations = new ArrayList<>(Arrays.asList(StationRepository.findByName("교대역"), StationRepository.findByName("남부터미널역"),
    ...
    private void line2Init() {
        List<Station> line2Stations = new ArrayList<>(Arrays.asList(StationRepository.findByName("교대역"),
